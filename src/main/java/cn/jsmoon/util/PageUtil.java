...
public class PageUtil {
	...
	public static String genPagination(String targetUrl,long totalNum,int currentPage,int pageSize,String param){
		...
		if(totalPage==0){
			...
			if(currentPage>1){
				pageCode.append("<li class='prev-page'><a href='"+targetUrl+"?page="+(currentPage-1)+"&"+param+"'>上一页</a></li>");
			}else{
			...
			if(currentPage<totalPage){
				pageCode.append("<li class='next-page'><a href='"+targetUrl+"?page="+(currentPage+1)+"&"+param+"'>下一页</a></li>");
			}else{
