...
!function () {
    ...
    for (var j = {MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8}, k = {
        L: 1,
        M: 0,
        Q: 3,
        H: 2
    ...
    function b(a, b, c) {
        ...
        e.className = "list-unstyled social-share social-share-" + c.size, b.forEach(function (a) {
            e.appendChild(f(a))
        }), a.appendChild(e)
    }
    ...
    function c(a, b) {
        var c = h[a];
        return c ? c(b) : (console.warn("[socialShare] plugin not found:" + a), null)
    }
    ...
    function e(a) {
        var b = {url: location.href, target: "", icon: "fa-share-alt", color: "#fff", background: "#b5b5b5"};
        return a.plugin && d(b, c(a.plugin, a.args || {})), d(b, a)
    }

    function f(a) {
        a = e(a);
        var b = document.createElement("li");
        b.className = "social-share-item";
        var c = document.createElement("a");
        c.href = a.url, c.target = a.target, c.style.background = a.background;
        var d = document.createElement("i");
        return d.className = "fa " + a.icon, d.style.color = a.color, c.appendChild(d), b.appendChild(c), "_qrcode" === a.target && (c.removeAttribute("target"), b.addEventListener("click", function (b) {
            b.preventDefault(), g(a.url, a.title || "Share Link")
        })), b
    }
    ...
    function g(a, b) {
        ...
        function e(a) {
            document.body.removeChild(f), window.removeEventListener("keydown", d)
        }

        var f = document.createElement("div");
        f.className = "social-share-dialog-bg";
        var g = document.createElement("div");
        g.className = "social-share-dialog";
        var h = document.createElement("div");
        h.className = "dialog-header", g.appendChild(h);
        var i = document.createElement("span");
        i.className = "dismiss", i.innerHTML = "&times", h.appendChild(i);
        var j = document.createElement("header");
        j.innerHTML = b, h.appendChild(j);
        var k = document.createElement("div");
        k.className = "dialog-body", g.appendChild(k);
        new QRCode(k, {
            text: a,
            width: 256,
            height: 256,
        ...
        i.addEventListener("click", e), g.addEventListener("click", c), f.addEventListener("click", e), window.addEventListener("keydown", d), f.appendChild(g), document.body.appendChild(f), setTimeout(function () {
            f.className += " show"
        })
    }
    ...
    a.plugin("facebook", function (a) {
        return {url: "//www.facebook.com/" + a.id, icon: "fa-facebook", background: "#3B5998"}
    })
}(window.socialShare), function (a) {
    a.plugin("github", function (a) {
        return {url: "//github.com/" + a.id, background: "#b5b5b5", icon: "fa-github"}
    })
}(window.socialShare), function (a) {
    a.plugin("google-plus", function (a) {
        return {url: "//plus.google.com/+" + a.id, icon: "fa-google-plus", background: "#C63D2D"}
    })
}(window.socialShare), function (a) {
    a.plugin("linkedin", function (a) {
        return {url: "//www.linkedin.com/in/" + a.id, background: "#4875B4", icon: "fa-linkedin"}
    })
}(window.socialShare), function (a) {
    a.plugin("qrcode", function (a) {
        return {target: "_qrcode", icon: "fa-qrcode", title: "Here is the Link!", background: "#555"}
    })
}(window.socialShare), function (a) {
    a.plugin("rss", function (a) {
        return {icon: "fa-rss", background: "#FA9B39"}
    })
}(window.socialShare), function (a) {
    a.plugin("twitter", function (a) {
        return {url: "//twitter.com/" + a.id, icon: "fa-twitter", background: "#33CCFF"}
    })
}(window.socialShare), function (a) {
    a.plugin("wechat", function (a) {
        return {target: "_qrcode", icon: "fa-wechat", background: "#77cc6d"}
    })
}(window.socialShare), function (a) {
    function b(a) {
        var b = "";
        for (var c in a)a.hasOwnProperty(c) && (b.length && (b += "&"), b += c + "=" + encodeURIComponent(a[c]));
        return b
    }

    a.plugin("weibo", function (a) {
        return a.title = a.title || document.title, a.url = a.url || location.href, {
            url: "//v.t.sina.com.cn/share/share.php?" + b(a),
            background: "#E6162D",
            icon: "fa-weibo"
        }
    })
